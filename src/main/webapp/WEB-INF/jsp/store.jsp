...
$(function(){
	...
	$("#datagrid").datagrid({
		...
		columns:[[    
		     ...
		     {field:'id',title:'(系统)仓库编号',width:80,align:'center'},    
		     {field:'name',title:'仓库名称',width:100,align:'center'},    
		     {field:'location',title:'仓库位置',width:80,align:'center'},    
		     {field:'amount',title:'容量',width:80,align:'center'},    
		     {field:'person',title:'仓库管理员',width:100,align:'center'},    
		]]  
	});
	/*添加和修改弹出的dialog */
	$("#dialog").dialog({
