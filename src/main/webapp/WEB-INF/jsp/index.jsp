	    	...
	    	$.post(
					...
					function(data) {
						...
						if(data.status == 0) {
							...
							window.location.href="${ctx}/index_login.action";
						}
						else{
...
<body class="easyui-layout">
	<div region="north" style="height: 78px; background-color: #f3f3f3">
		<table style="padding: 5px" width="100%">
			<tr>
				<td width="50%"><strong style="color: white; font-size: 38px;">&nbsp;&nbsp;&nbsp; 企业ERP管理系统</strong></td>
				<td valign="bottom" align="right" width="50%"><font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${admin.name }</font>【${admin.trueName }】
				</td>
				<td valign="bottom" align="right">
				<a href="javascript:logout()"
					class="easyui-linkbutton"
					data-options="plain:true,iconCls:'icon-exit'" style="width: 80px;">安全退出</a>
				</td>
			</tr>
		</table>
	</div>
		...
		<div class="easyui-tabs" fit="true" border="false" id="tabs">
			<div title="首页" data-options="iconCls:'icon-home'">
				<div align="center" style="padding-top: 100px">
					<font color="red" size="8">欢迎使用ERP管理系统</font>
					<br/>
					<br/>
					<br/>
					<font color="red" size="10">祝您工作愉快</font>
				</div>
				<div align="center">
					<br/>
					<br/>
	...
	<div region="west" style="width: 200px" title="导航菜单" split="true">
		<div class="easyui-accordion" data-options="fit:true,border:false">
			...
			<div title="员工管理" data-options="iconCls:'icon-fwgl'"
				style="padding: 10px">
				<a
					href="javascript:openTab('员工信息管理','${ctx}/to_employee.action','icon-fwcj')"
					class="easyui-linkbutton"
